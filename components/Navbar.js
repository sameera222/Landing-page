...
const Navbar = () => {
  return (
    <div className=" flex flex-row items-center justify-center  w-full bg-orange-400 ">
      {/* <Image
        alt="logo"
        src="https://cdn.doordash.com/static/img/favicon@2x.ico"
        width={60}
        height={10}
      /> */}
      <div 
      // className="mr-auto"
      className="flex flex-row items-center justify-end w-[55%] gap-2"
      >
        <svg
          aria-hidden="true"
          width="42"
        ...
        <div className="flex flex-row items-center justify-center ">
          <span className="font-bold text-white text-2xl tracking-widest text-center">
            DOORDASH
          </span>
        </div>
      </div>
      ...
      className="flex flex-row items-center w-[45%] justify-end p-2 m-2"
      >
        <div className="flex justify-end  gap-2">
          <div className="">
            <button
              type="button"
              className="text-white bg-orange-500 hover:bg-orange-600 focus:outline-none  rounded-full text-base px-4 py-2 text-center mb-2 font-bold"
            >
              Sign In
            </button>
          </div>
          <div>
            <button
              type="button"
              className="text-black bg-white  focus:outline-none  rounded-full text-base px-4 py-2 text-center mb-2 font-bold"
            >
              Sign Up
            </button>
          </div>
